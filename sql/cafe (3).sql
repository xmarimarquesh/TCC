...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/11/2023 às 14:20
...
INSERT INTO `carrinho` (`id_carrinho`, `id_usuario`, `id_produto`, `quantidade`, `chave_carrinho_temp`) VALUES
(17, 4, 1, 3, ''),
(18, 4, 7, 1, ''),
(19, 4, 2, 5, ''),
(20, 4, 4, 8, ''),
(23, 4, 14, 1, ''),
(24, 3, 2, 2, ''),
(25, 4, 13, 1, '6305vtlmhgm5fd6v01da13dft4');
...
(1, 'Vanilla Latte', 'Um toque clássico', 16.99, 'foto_produto/latte.png', 'cafe', 1),
(2, 'Affogato', 'Refrescante e equilibrado', 19.99, 'foto_produto/affogato.png', 'cafe', 0),
(3, 'Spiced Espresso Flat White', 'Deliciosas Notas de Sabor', 24.99, 'foto_produto/spiced.png', 'cafe', 0),
...
(13, 'Arranjo de Girassóis', 'Brilhe como o sol com nosso arranjo radiante de girassóis.', 169.9, 'foto_produto/arranjogirassol.png', 'flor', 1),
...
(16, 'Buquê Rosas Vermelhas', 'Um buquê de rosas vermelhas, a expressão clássica do amor apaixonado.', 159.9, 'foto_produto/buque24rosasvermelhas.png', 'flor', 0),
...
(20, 'Arranjo Flores Vermelhas Mistas', 'Expresse emoções intensas com nosso arranjo de flores vermelhas mistas, uma explosão de paixão e beleza.', 119.9, 'foto_produto/floresvermelhasmistas.png', 'flor', 1),
...
(4, 'Mateus', 'gabs@gmail.com', '$2y$10$PXEQzfNBJbIPNT8c5or0euJo2MRBZ99zztxL3MZB5ehaVrcYMwaKm', '81740719', 'UU', '45', 0),
